...
random_string(1 = Length, Wild) -> [random_char(rand:uniform(30), Wild) | random_string(Length-1, Wild)];
random_string(Length, Wild) -> [random_char(rand:uniform(30), Wild), 46 | random_string(Length-1, Wild)].
random_char(1, true) -> 42;
random_char(2, true) -> 35;
random_char(_N, _) -> rand:uniform(25) + 97.
